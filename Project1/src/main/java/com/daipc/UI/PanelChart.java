...
public class PanelChart extends javax.swing.JPanel {
    ...
    private DefaultComboBoxModel<String> modelNhom = new DefaultComboBoxModel<>();
    private DefaultComboBoxModel<String> modelTime = new DefaultComboBoxModel<>();
    private DefaultComboBoxModel<String> modelYear = new DefaultComboBoxModel<>();
